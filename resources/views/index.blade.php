  ...
  <section class="chicken-wrap">
    ...
    <div class="recipe-layout">
      ...
      <div class="right-grid">
        <div class="card"><img src="images/45902e2f62f4197b991d868f326488f89cbd56d2.jpg">
          <div class="info">
            <h3>CAJUN SAUSAGE AND VEGETABLES</h3>
            <p>$6.94 RECIPES/$1.74 SERVING</p>
          </div>
        </div>
        <div class="card"><img src="images/206e63c742e61d466f093d13334f02e7608e3b34.jpg">
          <div class="info">
            <h3>ONE POT CREAMY CAJUN CHICKEN PASTA</h3>
            <p>$6.94 RECIPES/$1.74 SERVING4</p>
          </div>
        </div>
        <div class="card"><img src="images/52c6a59c4cc934068800197a859bcd02a41b6ce8.jpg">
          <div class="info">
            <h3>CAJUN SAUSAGE AND VEGETABLES</h3>
            <p>$6.94 RECIPES/$1.74 SERVING</p>
          </div>
        </div>
        <div class="card"><img src="images/de08154ec3ced564eac1cf31aa22a03f172f2f8e (1).jpg">
          <div class="info">
            <h3>CAJUN SAUSAGE AND VEGETABLES</h3>
            <p>$6.94 RECIPES/$1.74 SERVING</p>
          </div>
