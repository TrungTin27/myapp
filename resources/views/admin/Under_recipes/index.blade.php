...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><strong>@lang('Under_recipes')</strong></h1>
    </div>
</div>

{{-- FILTER --}}
<div class="filter mb-3">
    <form action="{{ route('under_recipes.index') }}" method="GET">
        ...
        <div class="row mb-2 align-items-end">
            ...
            <div class="col-md-4 text-end">
                <a href="{{ route('under_recipes.create') }}"
...
<div class="card">
    <div class="custom-overflow repon">
        <table class="table">
            ...
            <tbody>
                @php
                $stt = ($Under_recipes->currentPage() - 1) * $Under_recipes->perPage();
                @endphp

                @forelse ($Under_recipes as $item)
                <tr class="text-center">
                    ...
                    <td>
                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                            href="{{ route('under_recipes.edit', $item->id) }}">
