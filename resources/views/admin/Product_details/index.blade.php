...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><strong>@lang('Danh sách chi tiết sản phẩm')</strong></h1>
    </div>
</div>
<div class="filter">
    <form class="" id="food" action="{{ route('product_details.index') }}" method="GET">
        <div class="row gutters-5 mb-2 gap-4" style="row-gap: 10px">
            ...
            <div class="col-md-4 text-md-right add-new ">
                <a href="{{ route('product_details.create') }}"
    ...
    <div class="custom-overflow repon">
        <table class="table ">
            ...
            <tbody>
                ...
                @php($stt = ($productDetails->currentPage() - 1) * $productDetails->perPage())
                @forelse ($productDetails as $key => $item)
                <tr class="text-center">
                    <td>{{ ++$stt }}</td>
                    ...
                    <td class="text-center">
                        ...
                        <a class="btn mb-1 btn-soft-primary btn-icon btn-circle btn-sm"
                            href="{{ route('productDetails.edit', $item->id) }}" title="@lang('Chỉnh sửa')">
