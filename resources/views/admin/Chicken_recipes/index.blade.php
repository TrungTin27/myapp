...
@section('title')
@lang('Chicken_recipes')
@endsection

@section('content')
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3"><strong>@lang('Chicken_recipes')</strong></h1>
    </div>
</div>

{{-- FILTER --}}
<div class="filter mb-3">
    <form action="{{ route('chicken_recipes.index') }}" method="GET">
        ...
        <div class="row mb-2 align-items-end">
            ...
            <div class="col-md-4 text-end">
                <a href="{{ route('chicken_recipes.create') }}"
...
<div class="card">
    <div class="custom-overflow repon">
        <table class="table">
            ...
            <tbody>
                @php
                $stt = ($Chicken_recipes->currentPage() - 1) * $Chicken_recipes->perPage();
                @endphp

                @forelse ($Chicken_recipes as $item)
                <tr class="text-center">
                    ...
                    <td>
                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                            href="{{ route('chicken_recipes.edit', $item->id) }}">
...
<script>
    $(document).on('click', '.click-modal-delete', function() {
        ...
        $.ajax({
            url: "{{ url('admin/chicken_recipes') }}/" + id + "/delete",
            type: "POST",
            data: {
                _method: "DELETE",
                _token: "{{ csrf_token() }}"
